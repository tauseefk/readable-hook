 ...
 */
export declare const useReadable: (streamProducer: (params?: Record<string, PrimitiveParam>) => Promise<ReadableStream<string>>, delay?: number) => [UseReadableHookData, (options?: {
